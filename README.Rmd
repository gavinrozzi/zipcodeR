...
Start a new project by downloading an exact registered bundle version (after
that data release is public), or reading a checksum-pinned file for an offline
workflow, then pass the bundle explicitly to `_ng` functions:
