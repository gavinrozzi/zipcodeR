...
[Codecov](https://app.codecov.io/gh/gavinrozzi/zipcodeR) · [CRAN
release](https://cran.r-project.org/package=zipcodeR) · [CRAN
downloads](https://cranlogs.r-pkg.org/downloads/total/last-month/zipcodeR)
<!-- badges: end -->
